...
/**
 * @author  Hernan Torrissi <hernantorrisi@gmail.com>
 * @url     https://github.com/bodymovin/bodymovin-extension
 * @license https://github.com/bodymovin/bodymovin-extension/blob/master/LICENSE
 *
 * The heavy duty bezier logic was taken from the Body Movin' opensource
 * AE extension. Without Hernan's amazing work, this would not have been possible.
 */
...
var bm_keyframeHelper = (function() {
    ...
    function exportKeys(prop, frRate, stretch, keyframeValues) {
        ...
        /* DISABLED */
        var exportOldFormat   = true; // $.__bodymovin.bm_renderManager.shouldExportOldFormat();
...
if (typeof console !== 'undefined') {
    console.log('bm_keyframeHelper loaded');
}
else if (debug instanceof Function) {
    debug('bm_keyframeHelper loaded');
}
